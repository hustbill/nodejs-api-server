// GET /v2/genealogy/dualteam/path?from=child-distributor-id
...
/**
 * Load dualteam tree path
 *
 * @method loadDualteamTreePath
 * @param request {Request} express request object.
 * @param callback {Function} callback function.
 */
function loadDualteamTreePath(request, callback) {
    ...
    genealogyDao.getDualteamTreePath(
        distributorId,
        childDistributorId,
...
/**
 * Return dualteam tree path json
 * @param request {Request} express request object.
...
function get(request, response, next) {
    async.series([
        ...
        function (callback) {
            loadDualteamTreePath(request, callback);
        },
        function (callback) {
