...
var sutPath = '../../../handlers/addressesShipping.js';
...
YUITest.TestRunner.add(new YUITest.TestCase({
    ...
    setUp : function () {
        ...
        this.request.context.memcachedClient.get = function (key, cb) {
            Assert.areSame(key, 'ShipAddress_123');
    ...
    testLoadAddressesShippingQueryError : function () {
    ...
    testLoadAddressesShippingQuerySuccess : function () {
        var handler = require(sutPath),
            self = this,
            dbResult = {
                rows : [
