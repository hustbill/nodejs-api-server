...
var sutPath = '../../../handlers/addressesBilling.js';

YUITest.TestRunner.add(new YUITest.TestCase({
    name : 'addressesBilling',
    ...
    setUp : function () {
        ...
        this.request.context.memcachedClient.get = function (key, cb) {
            Assert.areSame(key, 'BillAddress_123');
    ...
    testLoadAddressesBillingQueryError : function () {
    ...
    testLoadAddressesBillingQuerySuccess : function () {
        var handler = require(sutPath),
            self = this,
            dbResult = {
                rows : [
